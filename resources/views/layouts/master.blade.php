...
<!-- Mirrored from coderthemes.com/hyper/saas/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Aug 2023 10:25:49 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
       ...
       @yield('content')
        ...
        <!-- Vector Map js -->
        <script src="{{('assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.jss')}}"></script>
...
<!-- Mirrored from coderthemes.com/hyper/saas/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 20 Aug 2023 10:27:32 GMT -->
</html>          
