            ...
            <div class="col-md-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <form class="needs-validation" novalidate wire:submit.prevent="update_tv_live()">
                        <input type="hidden" name="tv_id" value="{{ $u_id }}">
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                           ...
                           <input type="file" class="form-control" id="channel_thumb"   name="channel_thumb" required wire:model="imageup" autocomplete="off" style="border: 1px solid #ccc;  display: inline-block; padding: 6px 12px; cursor: pointer;">
